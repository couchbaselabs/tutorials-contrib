...
image:../assets/images/00103-recent-shopping-carts.png[10 Most Recent Shopping Cart report]
...
image:../assets/images/00104-most-popular-items.png[Most popular items]
