...
NOTE: If you are using Couchbase Server 6.5+, you can link:http://docs.couchbase.com/tutorials/session-storage/udf.html[create a User-Defined Function] to simplify this query and avoid the need to use `BASE64_DECODE` multiple times in every query. 
