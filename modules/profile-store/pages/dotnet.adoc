...
There are a number of different ways to get started with Couchbase. Choose the method that's easiest for you. Check out link:https://docs.couchbase.com/tutorials/session-storage-tutorial/install.html[How to Setup and Configure a Couchbase Cluster] to review the options.
