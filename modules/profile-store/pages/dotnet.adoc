...
****
Where did the `_userRepository` come from? Check out the link://[GitHub repo for details]. The short story is that it also comes from dependency injection, also configured in Startup.cs.
****
