...
NOTE: Query Advisor is available starting in Couchbase Server 6.5 Beta, as a xref:6.5@server:developer-preview:preview-mode.adoc[developer preview mode] feature. As this tutorial was written, it is cutting edge. It is a very useful tool already, but please use it at your own risk.
