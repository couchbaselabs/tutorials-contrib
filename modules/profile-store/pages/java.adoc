...
NOTE: For more on User Events, read the xref:window-functions.adoc[Querying User Events with Window functions / CTE tutorial] which uses some features only available starting in Couchbase Server 6.5.
